...
export default function RegisterPage() {
    ...
    return (
        ...
        //     <form action="" onSubmit={registerUser} className='mt-4 max-w-md mx-auto'>
        //         <input type="text" placeholder="Username" value={name} onChange={e => setName(e.target.value)}/>
        //         <input type="email" placeholder={'your@email.com'} value={email} onChange={e => setEmail(e.target.value)} />
        //         <input type="password" placeholder='password' value={password} onChange={e => setPassword(e.target.value)}/>
        //         <input type="password" placeholder='Reenter your password' />
        //         <button className='login bg-primary hover:text-black hover:bg-white'>Register</button>
        //         <div className='text-center py-2 text-gray-600 cursor-default'>
        //             Already have an account? <Link to={'/login'} className="text-black hover:text-primary">Sign in</Link>
        //         </div>
        //     </form>
        //     </div>
        // </div>
      ...
      >
        ...
        >
          ...
          <p className="flex flex-col items-center justify-center mt-10 text-center">
            ...
            <Link to={'/Login'} className="underline text-white hover:text-dark"><span className="underline">Login</span></Link>
          </p>
        ...
        <div className="p-5 bg-white md:flex-1">
          ...
          <form onSubmit={registerUser} className="flex flex-col space-y-5">
             <div className="flex flex-col space-y-1">
              <label htmlFor="name" className="text-sm font-semibold text-gray-500">Username</label>
              <input
                type="text"
                id="name"
                value={name} 
